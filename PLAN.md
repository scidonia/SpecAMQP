...
- The trust boundary is disclosed exactly: Rust semantics, Charon/Aeneas translation, rustc/LLVM, the network, TLS, and the async runtime are trusted or assumed, and every claim states which side of that line it lives on.
