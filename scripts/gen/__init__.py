...
| `gen/slices.py` | the per-slice exchange corpora: the connection and session families, the widening family the corpus carries, and the mutation controls that are meant to fail | `scripts/gen-exchange-vectors.py` |
